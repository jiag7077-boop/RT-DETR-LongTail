...
```bash
# 1. Clone this repo
git clone https://github.com/jiag7077-boop/RT-DETR-LongTail.git
cd RT-DETR-LongTail
...
Head	damper	523
Medium	insulator_flashover	489
Medium	insulator_breakage	279
Medium	damper_defect	208
Medium	insulator_stringdrop	204
Tail	nest	77

Please refer to Section 4.1.1 of the paper for full dataset statistics.

DeepPCB Long-Tail Setting
1.Download the original DeepPCB dataset from tangsanli5201/DeepPCB.
...
Main Results
In-house Industrial Defect Dataset
Configuration	mAP@0.5:0.95	mAP@0.5	AP_H	AP_M	AP_T
...
Configuration	mAP@0.5:0.95	AP_H	AP_M
...
Configuration	mAP@0.5:0.95	AP_H	AP_M	AP_T
...
@article{gu2025robust,
  ...
  author  = {Gu, Jiahao and  zhang, siquan},
